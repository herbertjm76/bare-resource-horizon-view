      ...
      <CardContent className="p-4">
        <div className="flex items-center justify-between">
          <div className="flex-1 min-w-0 space-y-2">
            <p className="text-xs font-semibold text-white/90 mb-2 tracking-wide">Projects</p>
            <p className="text-3xl font-bold text-white mb-1 tracking-tight">{activeProjects}</p>
