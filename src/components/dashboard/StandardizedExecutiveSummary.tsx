...
export const StandardizedExecutiveSummary: React.FC<StandardizedExecutiveSummaryProps> = ({
  ...
  return (
    <div className="w-[80%] sm:w-full mx-auto bg-gradient-to-r from-purple-50 via-blue-50 to-indigo-50 rounded-xl p-3 sm:p-4 border border-purple-100/50 shadow-sm">
