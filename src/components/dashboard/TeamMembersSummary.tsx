    ...
    <div className="mb-3 relative">
      ...
      <div className="relative overflow-hidden rounded-xl">
        ...
        <div className="relative z-10 p-3">
          {/* Three rounded square cards with reduced padding */}
                ...
                <div className="space-y-1">
                  <div className="flex items-center justify-between text-xs">
                    <div className="flex items-center gap-1">
                      <UserCheck className="h-2.5 w-2.5 text-green-300" />
                  ...
                  <div className="flex items-center justify-between text-xs">
                    <div className="flex items-center gap-1">
                      <UserPlus className="h-2.5 w-2.5 text-orange-300" />
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-lg font-bold text-white">{Object.keys(departmentStats).length}</div>
                  </div>
                </div>
                  ...
                  {Object.entries(departmentStats)
                    ...
                    .map(([dept, count]) => (
                      <div key={dept} className="flex items-center justify-between text-xs">
                        <div className="flex items-center gap-1">
                          <div className={`w-1.5 h-1.5 rounded-full ${DEPARTMENT_COLORS[dept as keyof typeof DEPARTMENT_COLORS]} opacity-80`}></div>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-lg font-bold text-white">{Object.keys(locationStats).length}</div>
                  </div>
                </div>
                    ...
                    <>
                      {topLocations.slice(0, 2).map(([location, count]) => (
                        <div key={location} className="flex items-center justify-between text-xs">
                          <div className="flex items-center gap-1">
                            <span className="text-xs">{getLocationEmoji(location)}</span>
