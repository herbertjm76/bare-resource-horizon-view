  ...
  return (
    <div className="relative py-16 bg-gray-50 overflow-hidden">
      ...
      <div className="hidden xl:block absolute left-0 top-1/2 transform -translate-y-1/2 z-5">
        <AnimatedSection animation="cascadeScale" delay={200}>
          <img 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <AnimatedSection animation="cascadeUp" delay={0} className="text-center mb-8 sm:mb-12">
        ...
        <div className="max-w-4xl mx-auto">
          {comparisons.map((item, index) => (
            <AnimatedSection key={index} animation="cascadeUp" delay={200 + index * 250}>
