          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3 text-white/90">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium">Real-time Planning</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
                <span className="text-sm font-medium">Smart Balancing</span>
              </div>
            </div>
            ...
            <div className="text-white/70 text-sm">
              ⚡ Setup in 5 minutes • 🔒 Enterprise security • 📊 Works with existing tools
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="absolute -top-6 -left-6 bg-white/95 backdrop-blur-sm p-3 rounded-xl shadow-2xl z-10 animate-float">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="text-xs font-semibold text-gray-800">Productivity</div>
