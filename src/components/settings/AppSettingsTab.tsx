    ...
    <Card>
      ...
      <CardContent>
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          {/* Hours or Percentage */}
          <div className="space-y-2">
            <Label htmlFor="use_hours_or_percentage">Allocation Display</Label>
            <Select
            ...
            >
              <SelectTrigger id="use_hours_or_percentage">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
            ...
            <p className="text-xs text-muted-foreground">
              How to display resource allocations
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            >
              <SelectTrigger id="start_of_work_week">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
          ...
          <div className="space-y-2">
            <Label htmlFor="project_display_preference">Project Display</Label>
            <Select
            ...
            >
              <SelectTrigger id="project_display_preference">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
            ...
            <p className="text-xs text-muted-foreground">
              Display projects by code or name
            </p>
          </div>

          {/* Allocation Thresholds - spans full width */}
          <div className="space-y-2 lg:col-span-2">
            ...
            <p className="text-xs text-muted-foreground">
              Warning at {formData.allocation_warning_threshold}%, danger at {formData.allocation_danger_threshold}%, blocked above {formData.allocation_max_limit}%
            </p>
          </div>
        </div>
