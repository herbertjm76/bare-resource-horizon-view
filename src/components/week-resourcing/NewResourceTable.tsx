    ...
    <Table className="w-full border-collapse" style={{ minWidth: 1200 }}>
      <TableHeader>
        <TableRow className="border-b border-border bg-muted">
          {/* Team Member Column */}
          <TableHead className="sticky left-0 z-20 text-left px-3 py-3 font-semibold text-sm text-foreground bg-muted" style={{ width: 60, minWidth: 60 }}>
            Team Member
          </TableHead>
          ...
          {projectsWithHours.map((project) => (
            ...
            >
              <div className="flex items-end justify-center h-[120px] w-full overflow-hidden">
                <div
                  className="-rotate-90 whitespace-nowrap text-xs font-medium max-w-[100px] overflow-hidden text-ellipsis"
