...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center rounded-md bg-muted/20 text-muted-foreground",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[state=active]:bg-[#6E59A5] data-[state=active]:text-white data-[state=active]:font-semibold data-[state=active]:shadow-sm",
      // Inactive: muted gray text
      "data-[state=inactive]:bg-transparent data-[state=inactive]:text-[#8E9196] data-[state=inactive]:hover:bg-muted/30",
      className
    )}
    {...props}
  />
