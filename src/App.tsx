...
import WeeklyResourcePlanning from "./pages/WeeklyResourcePlanning";
        ...
        <TooltipProvider>
          ...
          <BrowserRouter>
            <Routes>
              ...
              <Route path="/weekly-resource-planning" element={<WeeklyResourcePlanning />} />
              <Route path="/weekly-overview" element={<WeeklyResourcePlanning />} />
