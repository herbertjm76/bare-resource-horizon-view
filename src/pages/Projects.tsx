  ...
  const metrics = [
    {
      ...
      badgeColor: totalProjects > 15 ? 'blue' as const : totalProjects > 8 ? 'green' as const : 'orange' as const
    },
    {
      ...
      badgeColor: activeProjects > 8 ? 'orange' as const : activeProjects > 4 ? 'blue' as const : activeProjects > 0 ? 'green' as const : 'purple' as const
    },
    {
      ...
      badgeColor: completionRate >= 80 ? 'green' as const : completionRate >= 60 ? 'blue' as const : completionRate >= 40 ? 'orange' as const : 'red' as const
    },
    {
      ...
      badgeColor: totalOffices > 3 ? 'blue' as const : totalOffices > 1 ? 'green' as const : 'purple' as const
    }
  ];
