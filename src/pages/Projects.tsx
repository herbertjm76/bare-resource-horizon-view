  ...
  const metrics = [
    {
      ...
      badgeColor: (totalProjects > 15 ? 'blue' : totalProjects > 8 ? 'green' : 'orange') as const
    },
    {
      ...
      badgeColor: (activeProjects > 8 ? 'orange' : activeProjects > 4 ? 'blue' : activeProjects > 0 ? 'green' : 'gray') as const
    },
    {
      ...
      badgeColor: (completionRate >= 80 ? 'green' : completionRate >= 60 ? 'blue' : completionRate >= 40 ? 'orange' : 'red') as const
    },
    {
      ...
      badgeColor: (totalOffices > 3 ? 'blue' : totalOffices > 1 ? 'green' : 'gray') as const
    }
  ];
