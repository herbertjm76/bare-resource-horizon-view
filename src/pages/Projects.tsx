  ...
  const metrics = [
    {
      ...
      badgeColor: (totalProjects > 15 ? 'blue' : totalProjects > 8 ? 'green' : 'orange') as 'green' | 'blue' | 'orange' | 'red' | 'gray' | 'purple'
    },
    {
      ...
      badgeColor: (activeProjects > 8 ? 'orange' : activeProjects > 4 ? 'blue' : activeProjects > 0 ? 'green' : 'gray') as 'green' | 'blue' | 'orange' | 'red' | 'gray' | 'purple'
    },
    {
      ...
      badgeColor: (completionRate >= 80 ? 'green' : completionRate >= 60 ? 'blue' : completionRate >= 40 ? 'orange' : 'red') as 'green' | 'blue' | 'orange' | 'red' | 'gray' | 'purple'
    },
    {
      ...
      badgeColor: (totalOffices > 3 ? 'blue' : totalOffices > 1 ? 'green' : 'gray') as 'green' | 'blue' | 'orange' | 'red' | 'gray' | 'purple'
    }
  ];
